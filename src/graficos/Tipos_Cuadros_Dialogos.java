	...
	private class Accion_botones implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==boton1){
				...
				JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this, "Has pulsado el boton 1", "Informativo", 1);
				...
				JOptionPane.showConfirmDialog(Lamina_Cuadros_Dialogos.this, "Has pulsado el botón 3", "titulo", 0);
				
				
			}else{
				
				System.out.println("Has pulsado el botón 4");				
				JOptionPane.showOptionDialog(Lamina_Cuadros_Dialogos.this, "Has pulsado el botón 4", "titulo", 1, 1, null, null, null);
